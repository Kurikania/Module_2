...
export default {
    ...
    methods: {
      ...
      addStudent() {
        ...
        function Student (name, lastName, hobbies, age) {
            this.name = name,
            this.lastName = lastName
            this.hobbies = hobbies, 
            this.age = age,
            this.university = "ИТМО"
            this.check = function() {
              console.log(`Студент  ${this.name}  ${this.lastName} возраст ${this.age} учитсв в ${this.university}. 
              Основные увлечения ${this.hobbies}`)
            }
          }

          let student = new Student(this.name, this.lastName,  this.hobbies, this.age)
          student.check()
